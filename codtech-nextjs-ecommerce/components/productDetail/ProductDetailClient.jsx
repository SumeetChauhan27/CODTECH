    ...
    <div className="flex flex-col md:flex-row gap-12 lg:gap-16">
      ...
      <div className="md:w-1/2">
        <div className="sticky top-24">
          ...
          <div className="grid grid-cols-4 gap-4 mt-4">
            {/* Mocking extra thumbnails with the same image for demonstration */}
            {[...Array(4)].map((_, i) => (
      ...
      <div className="md:w-1/2 flex flex-col">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-14">
          <div className="flex items-center border-2 border-gray-200 rounded-xl h-14 bg-gray-50 w-full sm:w-32 flex-shrink-0">
            <button onClick={decreaseQuantity} className="flex-1 text-gray-500 hover:text-orange-600 transition-colors h-full flex items-center justify-center font-bold text-xl">
              <FiMinus />
            </button>
            <span className="w-10 text-center font-bold text-gray-900">{quantity}</span>
            <button onClick={increaseQuantity} className="flex-1 text-gray-500 hover:text-orange-600 transition-colors h-full flex items-center justify-center font-bold text-xl">
              <FiPlus />
            </button>
          </div>
